## User Clarification Prompt Template 

## Entire Prompt Template and Deep Research Agent Prompt is defined
## This will allow the agent to take the necessary steps for user clarification and brief generation 
...
RULE: Before answering, you MUST ask at least one clarifying question unless the user has already provided enough information for you to start research.
...
- Example: "Research coffee quality factors (including bean sourcing, roasting methods, brewing techniques) for Toronto coffee shops, with primary focus on taste as specified by the user."
...
- *Example*: List the top 10 coffee shops in Toronto → Use 1 sub-agent
...
Criterion: "Monthly rent below 4k"
Brief: "...find apartments in Toronto with good amenities..."
...
<evaluation_examples>
Example 1 - PASS:
User criteria: ["Looking for coffee shops", "In Toronto"] 
Brief: "...research coffee shops in Toronto area..."
Judgment: PASS - stays within stated scope

Example 2 - FAIL:
User criteria: ["Looking for coffee shops", "In Toronto"]
Brief: "...research trendy coffee shops for young professionals in Toronto..."
